...
* xref:index.adoc[rollenspiel-cons arc42 architecture documentation]
** Context
...
**** Level 3
** Runtime view
*** xref:06_runtime_view/rollenspiel-cons.adoc[]
...
*** xref:rollenspiel-cons:ROOT:glossary.adoc[] (rollenspiel-cons Manual)
*** xref:rollenspiel-cons:ROOT:bibliography.adoc[] (rollenspiel-cons Manual)
